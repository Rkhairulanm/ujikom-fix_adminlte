            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image mx-auto text-center">
                        <a href="{{ route('profile.edit') }}"
                            class="d-block mx-auto text-center">{{ Auth::user()->name }}</a>
                    </div>
                </div>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="/produk" class="nav-link {{ $title == 'Kelola Produk' ? 'active' : '' }}">
                        ...
                        <li class="nav-item">
                            <a href="/pelanggan" class="nav-link {{ $title == 'Kelola Pelanggan' ? 'active' : '' }}">
                        ...
                        <li class="nav-item">
                            <a href="/detail" class="nav-link {{ $title == 'Detail Penjualan' ? 'active' : '' }}">
                        ...
                        <li class="nav-item">
                            <a href="pages/widgets.html" class="nav-link {{ $title == 'Struk' ? 'active' : '' }}">
                        ...
                        <li class="nav-header">ADINISTRATOR</li>
                        <li class="nav-item">
                            <a href="{{ route('register') }}    " class="nav-link"
                                {{ $title == 'registrasi' ? 'active' : '' }}>
